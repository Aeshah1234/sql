...
SUM(cp.quantity * cp.cost_to_customer_per_qty) AS total_amount_spent 
FROM customer c 
...
*/
--QUERY 9
--I started off with a create table, but it didn't work. It gave me an error that the table already existed.
--Therefore, after checking online, I saw DROP as a solution. 
...
VALUES (
	'4','Thomass Superfood Store','Fresh Focused','Thomas','Rosenthal'
); 
--END QUERY
